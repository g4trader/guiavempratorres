...
insert into public.businesses (
  ...
  phone, whatsapp, email, latitude, longitude, hero_image_path, hero_image_alt, published_at
) values
  ...
  ('20000000-0000-0000-0000-000000000006', 'Estúdio Mar de Mentirinha', 'estudio-mar-de-mentirinha', 'Rascunho fictício não publicado.', 'Empresa completamente fictícia que prova o bloqueio de rascunhos.', 'draft', 'Rua Não Publicada 606', 'Bairro Rascunho', null, null, 'draft@example.invalid', -29.348006, -49.738006, null, null, null);
...
insert into public.products_services (
  id, business_id, type, name, description, price, display_order
) values
  ('30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'product', 'Prato Modelo', 'Item fictício.', 49.90, 1),
  ('30000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', 'service', 'Menu Demonstração', 'Serviço fictício sem preço.', null, 2),
  ...
  ('30000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000003', 'service', 'Trilha Demonstração', 'Serviço fictício sem preço.', null, 2),
  ...
  ('30000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000005', 'product', 'Cesta Imaginária', 'Produto fictício.', 89.90, 1),
